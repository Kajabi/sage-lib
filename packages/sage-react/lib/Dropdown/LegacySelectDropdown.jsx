...
import {
  LEGACY_EMPTY_SELECTED_VALUE,
  DROPDOWN_PANEL_SIZES,
  DROPDOWN_POSITIONS
} from './configs';

export const LegacySelectDropdown = ({
  align,
  allowDeselect,
  allowMultiselect,
  className,
  ...
  const emptySelectedValue = LEGACY_EMPTY_SELECTED_VALUE;
...
LegacySelectDropdown.PANEL_SIZES = DROPDOWN_PANEL_SIZES;
LegacySelectDropdown.POSITIONS = DROPDOWN_POSITIONS;

LegacySelectDropdown.defaultProps = {
...
LegacySelectDropdown.propTypes = {
