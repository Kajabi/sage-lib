  ...
  def sage_components
    [
      ...
      },
      {
        ...
        description: "The Video Thumbnail is a preview image, overlayed with a play button, that plays your video in a modal.",
        scss: "done",
        docs: "done",
        rails: "done",
        react: "done",
        responsive: "todo",
        a11y: "done",
        react_component_slug: "sage-videothumbnail--default",
        figma_embed: "",
      },
    ]
  end
